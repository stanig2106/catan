...
public class CataneMapJob extends PaintingJob {
   ...
   public static class LandJob extends PaintingJob {
      final int size;
      private final Point mapCenter;
   ...
   public static class RouteJob extends PaintingJob {
      final int size;
      private final Point mapCenter;
   ...
   public static class BuildingJob extends PaintingJob {
      final int size;
      private final Point mapCenter;
   ...
   public static class BackgroundJob extends PaintingJob {
